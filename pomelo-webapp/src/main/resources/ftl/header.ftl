            ...
            <div class="navbar-container">
                ...
                <div class="header-menu">
                    <ul class="nav navbar-nav">
                        <li><a href="#" mcode="ADMIN-MENU-1">Dashboard</a>
                        </li>
                        <li><a href="#" mcode="ADMIN-MENU-3">UI元素</a>
                        </li>
                        <li><a href="#" mcode="ADMIN-MENU-4">UI组件</a>
                        </li>
                        <li><a href="#" mcode="ADMIN-MENU-5">表单</a>
                        </li>
                        <li><a href="#" mcode="ADMIN-MENU-6">数据表格</a>
                        </li>
                        <li><a href="#" mcode="ADMIN-MENU-7">面板</a>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">面板<span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="#" mcode="ADMIN-MENU-8">图表</a>
                                </li>
                                <li><a href="#" mcode="ADMIN-MENU-9">典型页面</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
